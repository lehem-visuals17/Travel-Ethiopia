    ...
    <div class="swiper-wrapper">
      ...
      <div class="swiper-slide">
        <div class="slide-img-container">
          <img class="welcome-img" src="images/cbe.jpg">
      ...
      <div class="swiper-slide">
        <div class="slide-img-container">
          <img class="welcome-img" src="images\sun.jpg">
          <div class="slide-overlay"></div>
        </div>
      </div>
      ...
      <div class="swiper-slide">
        <div class="slide-img-container">
          <img class="welcome-img" src="images/ethi.jpg">
          <div class="slide-overlay"></div>
        </div>
      </div>
...
<section class="travel-categories">
  <div class="header">
    ...
    <p>Choose your perfect travel style and start your adventure</p>
  </div>
  ...
  <div class="card-container">
    ...
    <div class="cards card-green">
      ...
      <p>Perfect short escapes to recharge your spirit</p>
      <span class="packages">12 Packages</span>
      <a href="#" class="explore">Explore &rsaquo;</a>
    </div>
    ...
    <div class="cards card-blue">
      ...
      <span class="packages">18 Packages</span>
      <a href="#" class="explore">Explore &rsaquo;</a>
    </div>
    ...
    <div class="cards card-purple">
      ...
      <p>Indulge in premium comfort and exclusivity</p>
      <span class="packages">8 Packages</span>
      <a href="#" class="explore">Explore &rsaquo;</a>
    </div>
    ...
    <div class="cards card-orange">
      ...
      <span class="packages">15 Packages</span>
      <a href="#" class="explore">Explore &rsaquo;</a>
    </div>
  </div>
</section>
...
<section class="featured-packages">
  <div class="header">
    ...
    <p>Carefully curated experiences designed for unforgettable memories</p>
  </div>
...
<div class="page-container">
  ...
  <header class="head">
    ...
    <p>Let our AI create your perfect Ethiopian adventure in seconds</p>
  </header>
...
<!-- Right Card Updated -->
    ...
    <div class="card empty-card">
       <i data-lucide="sparkles" class="big-sparkle"></i>

        <div class="empty-content">
     <i data-lucide="sparkles" class="large-sparkle"></i>
     <h3>AI Ready to Plan</h3>
     <p>Fill in your preferences and let our AI create your perfect Ethiopian journey</p>
  </div>
    </div>
...
<section class="newsletter-section">
  <div class="container">
    ...
    <h1>Get Exclusive Travel Deals</h1>
    <p class="subtitle">Subscribe to our newsletter and receive special offers, travel tips, and insider guides directly to your inbox</p>

    <!-- Pill Tags -->
    <div class="pill-container">
      <span class="pill"><i data-lucide="tag" class="pill-icon"></i> Exclusive Discounts</span>
      <span class="pill"><i data-lucide="zap" class="pill-icon"></i> Early Access to Deals</span>
      <span class="pill"><i data-lucide="sparkles" class="pill-icon"></i> Insider Travel Tips</span>
      <span class="pill"><i data-lucide="star" class="pill-icon"></i> Special Offers</span>
    </div>

    <!-- Subscription Form -->
    <form class="subscribe-form">
      <div class="input-wrapper">
        <i data-lucide="mail" class="mail-icon"></i>
        <input type="email" placeholder="Enter your email address">
      </div>
      <button type="submit" class="btn-subscribe">
        <i data-lucide="send" class="send-icon"></i> Subscribe Now
      </button>
    </form>
    ...
    <div class="stats-grid">
      ...
      <div class="stat-item">
        <h3>50+</h3>
        <span>Exclusive Deals/Month</span>
      </div>
      <div class="stat-item">
        <h3>98%</h3>
...
loginForm.onsubmit = (e) => {
  ...
  if (menuToggle && menuList) {
    ...
    document.addEventListener('click', (e) => {
      ...
      // 2. AUTH MODAL LOGIC (Login/Sign-up)
  const authModal = document.getElementById("auth-modal");
  const loginPills = document.querySelectorAll(".login-pill"); // Targets both mobile & desktop
  const closeAuthBtn = document.querySelector(".close-btn");
  const loginForm = document.getElementById("login-form");
  const signupForm = document.getElementById("signup-form");

  // Open Modal when clicking "Login/Sign up"
  loginPills.forEach(pill => {
    pill.addEventListener("click", () => {
      authModal.style.display = "block";
      menuList.classList.remove("active"); // Automatically close mobile menu
    });
  });
  ...
  if (searchBtn && destInput) {
    searchBtn.addEventListener("click", () => {
      if (destInput.value.trim() === "") {
        ...
        const destination = encodeURIComponent(destInput.value.trim());
        window.location.href = `index.html?search=${destination}#Destinations`;
      }
    });
  }
});
